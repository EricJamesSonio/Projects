verses = [
    ...
    ("And God said, 'Let there be a vault between the waters to separate water from water.'","1:6",),
    ("So God made the vault and separated the water under the vault from the water above it. And it was so.","1:7",),
    ("God called the vault 'sky.' And there was evening, and there was morning—the second day.","1:8",),
    ...
    ("And God said, 'Let there be lights in the vault of the sky to separate the day from the night, and let them serve as signs to mark sacred times, and days and years,'","1:14",),
    ("and let them be lights in the vault of the sky to give light on the earth.' And it was so.","1:15",),
    ("God made two great lights—the greater light to govern the day and the lesser light to govern the night. He also made the stars.","1:16",),
    ("God set them in the vault of the sky to give light on the earth,", "1:17"),
    ...
    ("And God said, 'Let the water teem with living creatures, and let birds fly above the earth across the vault of the sky.'","1:20",),
    ("So God created the great creatures of the sea and every living thing with which the water teems, and that moves about in it, according to their kinds, and every winged bird according to its kind. And God saw that it was good.","1:21",),
    ...
    ("And God said, 'Let the land produce living creatures according to their kinds: the livestock, the creatures that move along the ground, and the wild animals, each according to its kind.' And it was so.","1:24",),
    ...
    ("And to all the beasts of the earth and all the birds in the sky and all the creatures that move along the ground—everything that has the breath of life in it—I give every green plant for food.' And it was so.","1:30",),
